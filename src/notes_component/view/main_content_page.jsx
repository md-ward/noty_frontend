...
const MainContent = () => {
  const { notes, fetchNotes, deleteNote, currentPage, totalPages, setCurrentPage, showSearchInput, setSearchQuery, fetchSearchNotes } = useNotesStore();
  ...
  }, [showSearchInput, fetchNotes, setSearchQuery]);
