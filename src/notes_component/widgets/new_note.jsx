...
const NewNoteDialog = () => {
    ...
    return (
        ...
        >
            ...
            <div className=' ring-black flex sm:flex-col  justify-evenly ring-1 absolute bg-gray-50 rounded-md
            -top-16 w-80 max-sm:left-0 h-12
            sm:h-96 sm:w-12 sm:-right-16 sm:-top-0 '>
                <span className='relative sm:place-self-center max-sm:my-3' data-title='custom color' >
                    <input type='color' value={noteColor} className=' cursor-pointer w-6 h-6 p-1 aspect-square ring-rose-600 ring-2' ref={colorsRef}
                ...
                <span className='relative flex justify-center items-center'>
                    ...
                    <FontAwesomeIcon icon={faCheck} className=' absolute z-50  text-white text-center justify-self-center   cursor-pointer    ' size='xl' />

                    <span className=' absolute  bg-dark-blue w-8   aspect-square rounded-full  -z-0' id='btn'></span>
                </span>
