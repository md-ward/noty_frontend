...
const NoteDialog = ({ noteColor, title, text, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 mx-auto my-auto flex items-center justify-center z-50   w-full" >
            <div className="bg-white  shadow-lg p-6 rounded-lg " ref={NoteDialogRef} style={{ backgroundColor: noteColor }}>
                ...
                <p className="text-gray-700 overflow-auto h-96 p-1 w-72 sm:w-96 bg-white custom-scrollbar" >{text}</p>
